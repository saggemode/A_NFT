...
const Create = () => {
  ...
  async function createSale(e) {
    ...
    try {
      ...
      let transaction = await contract.createNFT(metadataURL);
      ...
      transaction = await contract.createVaultItem(
        hhnftaddress,
        tokenId,
        price,
        { value: listingFee }
  ...
  async function buyNFT() {
    ...
    let contract = new ethers.Contract(hhnftaddress, NFT, signer)
    let cost = await contract.cost()
    let transaction = await contract.mintNFT(metadataURL, { value: cost })
    await transaction.wait()
    alert("Successfully Buy your NFT!");
    updateMessage("");
    updateFormInput({ name: "", description: "", price: "" });
